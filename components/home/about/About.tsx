...
<Reveal>
  <p className={styles.aboutText}>
    My expertise includes Azure Monitor, Log Analytics, Data Collection Rules (DCR), BMC Discovery pattern development, and multi-tool monitoring platforms like SolarWinds, Site24x7, and EvolveOps.ai. I also focus on cost optimization by controlling log ingestion and building automation solutions that reduce manual operational effort.
  </p>
</Reveal>

<Reveal>
  <p className={styles.aboutText}>
    Beyond monitoring, I have a strong foundation in infrastructure, DevOps tools, and cloud governance including Linux, Windows Server, Terraform, Ansible, Kubernetes, and CI/CD pipelines. I enjoy solving complex operational challenges and improving reliability, performance, and cost efficiency.
  </p>
</Reveal>
